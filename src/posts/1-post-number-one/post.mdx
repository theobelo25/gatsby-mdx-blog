...
<GatsbyImage image={getImage(props.embeddedImages[1])} alt="random stuff" className="first-inline-img" />
<GatsbyImage image={getImage(props.embeddedImages[2])} alt="random stuff" className="first-inline-img" />
